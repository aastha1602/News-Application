...
function PostedNewsItems() {
  ...
  return (
    ...
    <Layout>
        ...
        {newsItems.length > 0 && (
          <div className='p-10'>
            <h1 className='text-2xl text-gray-600 mb-5 font-semibold'>Posted News Items</h1>
                  ...
                  return <tr>
                    ...
                    <td className='border-2 border-gray-500 p-2 items-center'>
                      <div className='flex justify-end space-x-5 pr-5 mt-5'>
                        <button className='px-5 py-1 bg-red-700 text-sm text-white' onClick={()=>deleteItem(item._id)}>Delete</button>
                        <button className='px-5 py-1 bg-green-500 text-sm text-white' onClick={() => navigate(`/edit/${item._id}`)} >Edit</button>
                      </div>
                    </td>
                  </tr>
                })}
