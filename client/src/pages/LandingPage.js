...
function LandingPage() {
  ...
  const login = async ()=>{
      ...
      try {
        ...
        localStorage.setItem('adnews-user' , JSON.stringify(result.data))
        navigate('/home')
        setLoading(false)
      } catch (error) {
...
useEffect(() => {
  if(localStorage.getItem('adnews-user'))
  navigate('/home')
}, [])
  ...
  return (
    <div className='h-screen flex items-center sm:flex-col'>
        ...
        <div className={`w-1/2 px-10 space-y-5 sm:w-screen ${(showLoginForm || showRegisterForm) && 'sm:hidden'}`}>
            <h1><b className='text-[#2B8F74] text-8xl'>AD</b> <b className='text-8xl text-gray-700'>NEWS</b></h1>
            <p className='text-lg'>
            ...
            <div className='space-x-5'>
              <button className='bg-gray-300 px-10 py-3' onClick={()=>{
                setShowRegisterForm(false)
                setShowLoginForm(true)
              }}>LOGIN</button>
              <button className='bg-[#2B8F74] px-10 py-3 text-white' onClick={()=>{
        ...
        <div className='w-1/2 sm:w-screen'>
            {(!showLoginForm && !showRegisterForm) && (<lottie-player 
            ...
            {showLoginForm && 
              ...
              <div className='ml-40 sm:ml-0'>
                    ...
                    {/* LoginForm */}
                    <h1 className='text-6xl text-gray-500 text-left w-full font-semibold my-5'>LOGIN</h1>
            ...
            {showRegisterForm && (
                <div className='ml-40 sm:ml-0'>
                    ...
                    {/* RegisterForm */}
                    <h1 className='text-6xl text-gray-500 text-left w-full font-semibold my-5'>REGISTER</h1>
                    <input 
                      value={name} 
